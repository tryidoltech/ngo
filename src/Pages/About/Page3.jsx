...
const Page3 = () => {
  return (
    <div className="flex flex-col gap-10 md:flex-row items-center  px-24 max-md:px-10 ">
      ...
      <div className="w-full space-y-4">
        <div>
        <h2 className="text-sm w-full font-normal  mr-[440px] text-indigo-600">ABOUT US</h2>
        <div className='w-10 bg-blue-700 h-[2px] ml-1 rounded-sm'></div>
        </div>
        <h1 className="text-3xl max-md:text-xl text-start font-bold pb-1 text-gray-800">
